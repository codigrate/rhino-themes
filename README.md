...
<h1 align="center">
Codigrate Themes for Rhino
</h1>

A carefully crafted collection of Rhinoceros 3D color themes inspired by nature and iconic cities around the world.
Each theme retints the modeling viewport, construction grid, command prompt and the surrounding interface chrome
into one coherent atmosphere, so long modeling sessions stay calm and easy on the eyes.
Whether you prefer deep, immersive dark environments or something softer,
these themes aim to make Rhino feel both elegant and comfortable.
...
<a href="https://github.com/codigrate/rhino-themes/graphs/contributors">
   <img src="https://contrib.rocks/image?repo=codigrate/rhino-themes" alt="Contributors"/>
</a>
